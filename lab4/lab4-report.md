...
**(Б)** Шлем данные напрямую из API в сервисы, а сервисы всё посчитают, сложат файлы в хранилище и метрики в бд, но тогда у сервисов появляется больше задач, а это отнимает работу у AI API. 
